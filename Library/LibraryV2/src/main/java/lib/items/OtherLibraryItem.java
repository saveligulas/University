...
public abstract class OtherLibraryItem extends LibraryItem {
    ...
    public OtherLibraryItem(String _identifier, int _copyNumber, String _title, String _publisher, String _intellectualOwner, String description, Set<Category> _categories) {
